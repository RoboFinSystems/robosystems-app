...
export const getAuthProviders = vi.fn()
// Passkey MFA surface (client >= 1.10)
export const getPasskeyRegistrationOptions = vi.fn()
export const verifyPasskeyRegistration = vi.fn()
export const listUserPasskeys = vi.fn()
export const deleteUserPasskey = vi.fn()
export const getPasskeyReauthOptions = vi.fn()
export const getPasskeyLoginOptions = vi.fn()
export const verifyPasskeyLogin = vi.fn()
export const getMfaOptions = vi.fn()
export const verifyMfa = vi.fn()
export const getMfaStatus = vi.fn()
export const regenerateMfaRecoveryCodes = vi.fn()
