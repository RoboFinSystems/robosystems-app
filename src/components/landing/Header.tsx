      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Tighter spacing at lg so the row survives the extra Enterprise
              ...
              available at 1024px, ~680px needed at space-x-1 before GitHub
              went icon-only, which freed ~60px more); back to space-x-6 from
              xl. space-x-6 at lg would still overflow. */}
          <nav className="hidden whitespace-nowrap lg:flex lg:space-x-1 xl:space-x-6">
            ...
            <a
              ...
              className="hover:text-secondary-400 p-2 text-gray-400 transition-colors"
            >
