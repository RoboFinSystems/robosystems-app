...
const PROSE =
  'prose prose-invert max-w-none prose-headings:font-heading prose-headings:scroll-mt-28 prose-headings:text-white prose-p:text-gray-300 prose-a:text-cyan-400 prose-a:no-underline hover:prose-a:text-cyan-300 prose-strong:text-white prose-code:text-cyan-300 prose-code:before:content-none prose-code:after:content-none prose-pre:border prose-pre:border-gray-800 prose-pre:bg-gray-900 prose-li:text-gray-300 prose-li:marker:text-cyan-500 prose-th:text-white prose-td:text-gray-300 prose-blockquote:border-l-cyan-500 prose-blockquote:text-gray-400'
